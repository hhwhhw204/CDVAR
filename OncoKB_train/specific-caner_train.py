...
if __name__ == '__main__':
    ...
    ########## trainset ##########
    dna_fea = torch.load(f'../../data/OncoKB_trainset/Specific-cancer/{args.cancer}/{args.cancer}_dna_fea.pt')
    prt_rep = torch.load(f'../../data/OncoKB_trainset/Specific-cancer/{args.cancer}/{args.cancer}_prt_rep.pt')
    panfea = torch.load(f'../../data/OncoKB_trainset/Specific-cancer/{args.cancer}/{args.cancer}_panfea_data.pt')
    labels = torch.load(f'../../data/OncoKB_trainset/Specific-cancer/{args.cancer}/{args.cancer}_labels.pt')
