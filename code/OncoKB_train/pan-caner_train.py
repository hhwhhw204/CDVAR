...
def k_verify(X, P, F, Y, args):
    ...
    for i in range(1, k + 1):
        ...
        if sum(val_losses) < min_val_loss:
            ...
            torch.save(net.state_dict(), f"save_model/Pan-cancer_best_model_{args.mul}_tmp.pth")
...
if __name__ == '__main__':
    ...
    neg_sample = f"COSMIC_sample4OncoKB_mul{args.mul}_seed42"
    print("Loading processed prt repr by ESMfold...")
    pos_prt_path = f"../../data/feature/prt_repr/OncoKB/OncoKB_prt_200aa_repr.npy" 
    ...
    pos_dna_path = f"../../data/feature/dna_repr/OncoKB/OncoKB_dna_500bp_repr.npy" 
    ...
    pos_panfea_path = f"../../data/feature/statistics/OncoKB/OncoKB_100bpx2_statistics.tsv"
